...
class AddPostActivity : AppCompatActivity() {
    ...
    private fun uploadImage() {
        when {
            ...
            description_post.text.toString() == "" -> Toast.makeText(this, "Please fill in description field.", Toast.LENGTH_LONG).show()

            else -> {
                val progressDialog = ProgressDialog(this)
                progressDialog.setTitle("Add Post")
                progressDialog.setMessage("Please wait, creating post...")
                progressDialog.show()
